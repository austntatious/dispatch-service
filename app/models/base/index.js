...
nucleusBookshelf.Model = nucleusBookshelf.Model.extend({
    ...
    contextUser: function contextUser(options) {
        ...
        // Other wise use the internal override
            ...
            errors.logAndThrowError(new Error(console.log('errors.models.base.index.missingContext')));
        }
    },
    ...
    */
     ...
     * @return {Promise(nucleusBookshelf.Collection)} Collection of all Models
     */
     ...
     * @param {Object} data
     * @param {Object} options (optional)
     * @return {Promise(nucleusBookshelf.Model)} Single Model
     */
     ...
     * @param {Object} data
     * @param {Object} options (optional)
     * @return {Promise(nucleusBookshelf.Model)} Edited Model
     */
     ...
     * @param {Object} data
     * @param {Object} options (optional)
     * @return {Promise(nucleusBookshelf.Model)} Newly Added Model
     */
     ...
     * Naive destroy
     * @param {Object} options (optional)
     * @return {Promise(nucleusBookshelf.Model)} Empty Model
     */
...
// Export nucleusBookshelf for use elsewhere
module.exports = nucleusBookshelf;